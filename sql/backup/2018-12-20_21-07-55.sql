...
INSERT INTO `admin_users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`) VALUES (1, '127.0.0.1', 'webmaster', '$2y$08$/X5gzWjesYi78GqeAv5tA.dVGBVP7C1e1PzqnYCVe5s1qhlDIPPES', NULL, NULL, NULL, NULL, NULL, NULL, 1451900190, 1545327910, 1, 'Webmaster', '');
...
INSERT INTO `groups` (`id`, `name`, `description`) VALUES (2, 'Engineers', '');
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`) VALUES (2, '127.0.0.1', 'pf', '$2y$08$NNrPuK/tKkTZzLMIpC2gkeDHrSXOnH2fl/YrZru5PjKM1r6d/6FFK', NULL, 'patrondumitru@gmail.com', NULL, NULL, NULL, NULL, 1535744228, NULL, 1, 'Dumitru', 'Patron', NULL, NULL);
