...
#
# TABLE STRUCTURE FOR: admin_groups_permissions
#

DROP TABLE IF EXISTS `admin_groups_permissions`;

CREATE TABLE `admin_groups_permissions` (
...
INSERT INTO `admin_groups_permissions` (`id`, `group_id`, `perm_id`, `value`, `created_at`, `updated_at`) VALUES (1, 5, 1, 1, 1546037036, 1546037036);
INSERT INTO `admin_groups_permissions` (`id`, `group_id`, `perm_id`, `value`, `created_at`, `updated_at`) VALUES (10, 1, 4, 1, 1546551980, 1546551980);
INSERT INTO `admin_groups_permissions` (`id`, `group_id`, `perm_id`, `value`, `created_at`, `updated_at`) VALUES (11, 1, 2, 1, 1546551980, 1546551980);
...
INSERT INTO `admin_permissions` (`id`, `perm_key`, `perm_name`, `url_name`) VALUES (24, 'admin_util_remove_db', 'Admin Util Remove_db', NULL);
INSERT INTO `admin_permissions` (`id`, `perm_key`, `perm_name`, `url_name`) VALUES (25, 'admin_panel_manage', 'Admin Panel Manage', NULL);
INSERT INTO `admin_permissions` (`id`, `perm_key`, `perm_name`, `url_name`) VALUES (26, 'admin_user_permissions', 'Admin User Permissions', NULL);
INSERT INTO `admin_permissions` (`id`, `perm_key`, `perm_name`, `url_name`) VALUES (27, 'admin_user_manage', 'Admin User Manage', NULL);
INSERT INTO `admin_permissions` (`id`, `perm_key`, `perm_name`, `url_name`) VALUES (28, 'admin_user_users', 'Admin User Users', NULL);
INSERT INTO `admin_permissions` (`id`, `perm_key`, `perm_name`, `url_name`) VALUES (29, 'admin_user_manage_user', 'Admin User Manage_user', NULL);
INSERT INTO `admin_permissions` (`id`, `perm_key`, `perm_name`, `url_name`) VALUES (30, 'admin_user_groups', 'Admin User Groups', NULL);
INSERT INTO `admin_permissions` (`id`, `perm_key`, `perm_name`, `url_name`) VALUES (31, 'admin_user_group_permissions', 'Admin User Group_permissions', NULL);
INSERT INTO `admin_permissions` (`id`, `perm_key`, `perm_name`, `url_name`) VALUES (32, 'admin_user_update_permission', 'Admin User Update_permission', NULL);
INSERT INTO `admin_permissions` (`id`, `perm_key`, `perm_name`, `url_name`) VALUES (33, 'admin_user_add_permission', 'Admin User Add_permission', NULL);
INSERT INTO `admin_permissions` (`id`, `perm_key`, `perm_name`, `url_name`) VALUES (34, 'admin_project_dashboard', 'Admin Project Dashboard', NULL);
INSERT INTO `admin_permissions` (`id`, `perm_key`, `perm_name`, `url_name`) VALUES (35, 'admin_project_add', 'Admin Project Add', NULL);
INSERT INTO `admin_permissions` (`id`, `perm_key`, `perm_name`, `url_name`) VALUES (36, 'admin_project_addform', 'Admin Project Addform', NULL);
...
INSERT INTO `admin_users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`) VALUES (1, '127.0.0.1', 'webmaster', '$2y$08$/X5gzWjesYi78GqeAv5tA.dVGBVP7C1e1PzqnYCVe5s1qhlDIPPES', NULL, NULL, NULL, NULL, NULL, NULL, 1451900190, 1547752102, 1, 'Webmaster', '');
...
INSERT INTO `admin_users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`) VALUES (6, '127.0.0.1', 'eng', '$2y$08$EaWuMzVDtiwsfmOkAXSMwOa7MgTTb65/HLx9omO.2HvEbSK1mtvMO', NULL, NULL, NULL, NULL, NULL, NULL, 1546284020, NULL, 1, 'Enginer 1', 'Enginer 1');
INSERT INTO `admin_users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`) VALUES (7, '127.0.0.1', 'eng2', '$2y$08$BBxEAaVzMHHnheAUeuSdPunUAf5dIJ3ZtLmBZZVTqPZr7.pphpsui', NULL, NULL, NULL, NULL, NULL, NULL, 1546285496, NULL, 1, 'Engineer 2', 'Engineer 2');
...
INSERT INTO `admin_users_groups` (`id`, `user_id`, `group_id`) VALUES (6, 6, 4);
INSERT INTO `admin_users_groups` (`id`, `user_id`, `group_id`) VALUES (7, 6, 5);
INSERT INTO `admin_users_groups` (`id`, `user_id`, `group_id`) VALUES (8, 6, 6);
INSERT INTO `admin_users_groups` (`id`, `user_id`, `group_id`) VALUES (9, 7, 3);
INSERT INTO `admin_users_groups` (`id`, `user_id`, `group_id`) VALUES (10, 7, 4);
INSERT INTO `admin_users_groups` (`id`, `user_id`, `group_id`) VALUES (11, 7, 5);
INSERT INTO `admin_users_groups` (`id`, `user_id`, `group_id`) VALUES (12, 7, 6);
...
INSERT INTO `admin_users_permissions` (`id`, `user_id`, `perm_id`, `value`, `created_at`, `updated_at`) VALUES (21, 1, 3, 0, 1546551783, 1546551783);
INSERT INTO `admin_users_permissions` (`id`, `user_id`, `perm_id`, `value`, `created_at`, `updated_at`) VALUES (23, 1, 1, 1, 1546552015, 1546552015);
...
INSERT INTO `project` (`prj_id`, `prj_name`, `status_id`, `prj_engineer`, `prj_manager`, `prj_inspector`, `prj_location_id`, `prj_date_created`, `prj_created_user_id`) VALUES (5, 'My first edit project', 2, 6, 3, 6, 3, '2018-08-01 00:00:00', 1);
INSERT INTO `project` (`prj_id`, `prj_name`, `status_id`, `prj_engineer`, `prj_manager`, `prj_inspector`, `prj_location_id`, `prj_date_created`, `prj_created_user_id`) VALUES (6, 'test 1', 2, 7, 3, 7, 1, '2018-08-29 00:00:00', 1);
INSERT INTO `project` (`prj_id`, `prj_name`, `status_id`, `prj_engineer`, `prj_manager`, `prj_inspector`, `prj_location_id`, `prj_date_created`, `prj_created_user_id`) VALUES (7, 'test234', 1, 6, 7, 6, 3, '2018-09-05 05:21:20', 1);
...
INSERT INTO `project` (`prj_id`, `prj_name`, `status_id`, `prj_engineer`, `prj_manager`, `prj_inspector`, `prj_location_id`, `prj_date_created`, `prj_created_user_id`) VALUES (14, 'test', 1, 6, 3, 6, 3, '2019-01-09 06:58:14', 1);
...
CREATE TABLE `project_form_structure` (
  ...
  `str_field_subgroup_grid` varchar(10) NOT NULL,
  `str_field_subgroup_size` int(2) NOT NULL,
  `str_field_subgroup_class` varchar(50) NOT NULL,
  `str_field_helpblock` varchar(255) NOT NULL,
...
INSERT INTO `project_form_structure` (`structure_id`, `form_id`, `type_id`, `str_field_name`, `str_field_label`, `str_type`, `str_field_order`, `str_field_group`, `str_field_group_order`, `str_field_subgroup`, `str_field_subgroup_order`, `str_field_value`, `str_field_placeholder`, `str_field_subgroup_grid`, `str_field_subgroup_size`, `str_field_subgroup_class`, `str_field_helpblock`, `str_field_required`, `str_field_rule`, `str_field_class`) VALUES (1, 1, 1, 'temp_high', 'Temperature (high)', 5, 4, 'Project', 1, 'General', 1, '2', '', 'col-md', 6, '', '', 1, '', '');
INSERT INTO `project_form_structure` (`structure_id`, `form_id`, `type_id`, `str_field_name`, `str_field_label`, `str_type`, `str_field_order`, `str_field_group`, `str_field_group_order`, `str_field_subgroup`, `str_field_subgroup_order`, `str_field_value`, `str_field_placeholder`, `str_field_subgroup_grid`, `str_field_subgroup_size`, `str_field_subgroup_class`, `str_field_helpblock`, `str_field_required`, `str_field_rule`, `str_field_class`) VALUES (2, 1, 1, 'temp_low', 'Temperature (low)', 5, 1, 'Project', 1, 'General', 1, '7', '', 'col-md', 4, 'has-success ', 'Atentie', 1, 'numeric', '');
INSERT INTO `project_form_structure` (`structure_id`, `form_id`, `type_id`, `str_field_name`, `str_field_label`, `str_type`, `str_field_order`, `str_field_group`, `str_field_group_order`, `str_field_subgroup`, `str_field_subgroup_order`, `str_field_value`, `str_field_placeholder`, `str_field_subgroup_grid`, `str_field_subgroup_size`, `str_field_subgroup_class`, `str_field_helpblock`, `str_field_required`, `str_field_rule`, `str_field_class`) VALUES (3, 1, 1, 'prep_volume', 'Precipitation Volume (in)', 3, 1, 'Project', 1, 'Condition', 3, '4;6', '', 'col-md', 4, '', '', 1, '', '');
INSERT INTO `project_form_structure` (`structure_id`, `form_id`, `type_id`, `str_field_name`, `str_field_label`, `str_type`, `str_field_order`, `str_field_group`, `str_field_group_order`, `str_field_subgroup`, `str_field_subgroup_order`, `str_field_value`, `str_field_placeholder`, `str_field_subgroup_grid`, `str_field_subgroup_size`, `str_field_subgroup_class`, `str_field_helpblock`, `str_field_required`, `str_field_rule`, `str_field_class`) VALUES (4, 1, 3, 'weather_day', 'Weather Day?', 1, 1, 'Project', 1, 'Weather', 2, '', 'descrietei ce doriti', 'col-xs', 2, '', '', 1, '', 'input-lg');
INSERT INTO `project_form_structure` (`structure_id`, `form_id`, `type_id`, `str_field_name`, `str_field_label`, `str_type`, `str_field_order`, `str_field_group`, `str_field_group_order`, `str_field_subgroup`, `str_field_subgroup_order`, `str_field_value`, `str_field_placeholder`, `str_field_subgroup_grid`, `str_field_subgroup_size`, `str_field_subgroup_class`, `str_field_helpblock`, `str_field_required`, `str_field_rule`, `str_field_class`) VALUES (5, 1, 2, 'weather_month', 'Weather Month', 5, 1, 'Organization', 2, 'General', 1, '', '', 'col-md', 3, 'has-success ', 'Fiti atenti la acest mesaj', 0, '', '');
INSERT INTO `project_form_structure` (`structure_id`, `form_id`, `type_id`, `str_field_name`, `str_field_label`, `str_type`, `str_field_order`, `str_field_group`, `str_field_group_order`, `str_field_subgroup`, `str_field_subgroup_order`, `str_field_value`, `str_field_placeholder`, `str_field_subgroup_grid`, `str_field_subgroup_size`, `str_field_subgroup_class`, `str_field_helpblock`, `str_field_required`, `str_field_rule`, `str_field_class`) VALUES (6, 1, 2, 'custom', 'Custom', 2, 1, 'Organization', 2, 'Weather', 1, '', '', 'col-lg', 2, '', '', 0, '', '');
INSERT INTO `project_form_structure` (`structure_id`, `form_id`, `type_id`, `str_field_name`, `str_field_label`, `str_type`, `str_field_order`, `str_field_group`, `str_field_group_order`, `str_field_subgroup`, `str_field_subgroup_order`, `str_field_value`, `str_field_placeholder`, `str_field_subgroup_grid`, `str_field_subgroup_size`, `str_field_subgroup_class`, `str_field_helpblock`, `str_field_required`, `str_field_rule`, `str_field_class`) VALUES (7, 1, 1, 'expert', 'Expert', 4, 2, 'Project', 1, 'General', 1, '8', '', 'col-md', 3, 'has-warning', '', 1, '', '');
INSERT INTO `project_form_structure` (`structure_id`, `form_id`, `type_id`, `str_field_name`, `str_field_label`, `str_type`, `str_field_order`, `str_field_group`, `str_field_group_order`, `str_field_subgroup`, `str_field_subgroup_order`, `str_field_value`, `str_field_placeholder`, `str_field_subgroup_grid`, `str_field_subgroup_size`, `str_field_subgroup_class`, `str_field_helpblock`, `str_field_required`, `str_field_rule`, `str_field_class`) VALUES (8, 1, 1, 'file', 'Upload picture', 6, 3, 'Project', 1, 'General', 1, '', '', 'col-md', 6, '', '', 0, '', '');
