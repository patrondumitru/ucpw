...
$route['^(\w{2})/iframe/(:num)']	= "iframe/view/$2";
/*
| -------------------------------------------------------------------------
...
//$route[trim(dirname($_SERVER['SCRIPT_NAME']), '/\\').'/(\w{2})$'] = $route['default_controller'];
if (!empty(trim(dirname($_SERVER['SCRIPT_NAME']), '/\\'))) $route['^'.strtolower(trim(dirname($_SERVER['SCRIPT_NAME']), '/\\')).'/(\w{2})$'] = $route['default_controller'];
/*
| -------------------------------------------------------------------------
| Added by CI Bootstrap 3
