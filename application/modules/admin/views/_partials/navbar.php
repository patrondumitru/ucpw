                                    ...
                                    <li>
                                        <ul class="menu">
                                            <li><!-- start message -->
                                                <a href="#">
                                                    <div class="pull-left">
                                                        <img src="<?php echo base_url($assets_dir . '/uploads/avatar/m_002.png'); ?>" class="img-circle" alt="User Image">
                                                    </div>
...
<?php if ($admin_prefs['user_menu'] == TRUE): ?>
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="<?php echo base_url($assets_dir . '/uploads/avatar/m_001.png'); ?>" class="user-image" alt="User Image">
                                    <span class="hidden-xs"><?php echo $user->username; ?></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <li class="user-header">
                                        <img src="<?php echo base_url($assets_dir . '/uploads/avatar/m_001.png'); ?>" class="img-circle" alt="User Image">
                                        <p><?php echo $user->first_name.$user->last_name; ?><small><?php echo lang('header_member_since'); ?> <?php echo date('d-m-Y', $user->created_on); ?></small></p>
                                    </li>
                                    <li class="user-body">
                                        <div class="row">
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="<?php echo site_url('admin/users/profile/'.$user->id); ?>" class="btn btn-default btn-flat"><?php echo lang('header_profile'); ?></a>
                                        </div>
