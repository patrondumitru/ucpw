...
<ul>
    ...
    <li><?php echo anchor('/admin/user/users', 'Back to Users'); ?></li>
</ul>
...
<h3>Users Permissions (<a href="/admin/user/user_permissions/<?php echo $user->id; ?>">Manage User Permissions</a>)</h3>
<ul>
