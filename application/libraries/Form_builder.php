...
class Form {
	...
	public function b_text($label, $name, $value = NULL, $class="form-group", $extra = array())
	{
		$extra['class'] = 'form-control';
		$extra['id'] = $name;
		return '<div class="'.$class .'">'.lang($label, $name, array('class' => 'col-sm-2 control-label')).'<div class="col-sm-10">'.$this->field_text($name, $value, $extra).'</div></div>';
	}
	...
	public function b_email($label, $name = 'email', $value = NULL, $class="form-group", $extra = array())
	{
		$extra['class'] = 'form-control';
		$extra['id'] = $name;
		return '<div class="'.$class .'">'.lang($label, $name, array('class' => 'col-sm-2 control-label')).'<div class="col-sm-10">'.$this->field_email($name, $value, $extra).'</div></div>';
	}
	...
	public function bs3_dropdown($label, $name, $value = NULL, $options = array(), $extra = array())
	{
		$extra['class'] = 'form-control';
		return '<div class="form-group">'.form_label($label, $name).$this->field_dropdown($name, $value, $options, $extra).'</div>';
	}


	public function b_dropdown($label, $name, $value = NULL, $options = array(), $class="form-group", $extra = array())
	{
		$extra['class'] = 'form-control';
		$extra['id'] = $name;
		return '<div class="'.$class .'">'.lang($label, $name, array('class' => 'col-sm-2 control-label')).'<div class="col-sm-10">'.$this->field_dropdown($name, $value, $options, $extra).'</div></div>';
	}
	...
	public function bs3_reset($label = 'Reset', $class = 'btn btn-primary', $extra = array())
	{
		$extra['class'] = $class;
		return $this->btn_reset($label, $extra);
	}
	public function b_hidden($name = 'id', $value = NULL, $extra = array())
	{	
		return form_hidden($name, $value, $extra);
	}
